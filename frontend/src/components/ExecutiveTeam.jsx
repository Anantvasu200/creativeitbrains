...
export default function ExecutiveTeam() {
  return (
    <section id="team" className="bg-[#070809] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 border-t border-white/10 pt-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="grid gap-5 md:grid-cols-2">
          {executiveTeam.map((member, index) => (
            <article className={`${index === 2 ? 'md:translate-y-10' : ''} rounded-xl border border-white/10 bg-[#0d1012] p-6 transition duration-200 hover:border-white/18 hover:bg-[#111518]`} key={member.name}>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#8ee6df]">Executive Team</p>
