  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      {[
        ...
        <motion.span
          key={`${left}-${top}`}
          className="absolute size-2 rounded-sm border border-[#0f6cff]/35 bg-[#11151b] shadow-[0_0_18px_rgba(15,108,255,0.24)]"
          style={{ left, top }}
      ...
      <motion.div
        className="absolute right-[8%] top-[12%] h-[420px] w-[420px] rounded-[2rem] border border-white/10 bg-white/[0.025]"
        animate={{ rotate: [0, 6, 0], x: [0, 18, 0], y: [0, -12, 0] }}
        transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }}
      />
      <motion.div
        className="absolute bottom-[10%] left-[42%] h-32 w-64 rounded-lg border border-white/10 bg-white/[0.035]"
...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative flex min-h-screen items-center overflow-hidden bg-[#090b10] px-4 pt-24 pb-14 text-white sm:px-6 sm:pt-28 lg:px-8"
    >
      <video
      ...
      <div className="absolute inset-0 z-[1] bg-[linear-gradient(90deg,#090b10_0%,rgba(9,11,16,0.92)_42%,rgba(9,11,16,0.72)_100%)]" />
      <div className="absolute inset-x-0 bottom-0 z-[1] h-48 bg-gradient-to-t from-[#090b10] to-transparent" />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-12 lg:items-center">
        <div className="relative z-10 max-w-full text-left lg:col-span-7">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            ...
            <a
              className="inline-flex w-full items-center justify-center rounded-lg border border-white/10 bg-[#11151b] px-7 py-3.5 font-bold text-white transition duration-200 hover:border-white/25 hover:bg-white/[0.06] sm:w-auto"
              href="#services"
            >
              View Services
            </a>
        ...
        <div className="relative hidden justify-center lg:col-span-5 lg:flex">
          <div
            ...
            className="relative w-full max-w-[470px] overflow-hidden rounded-xl border border-white/10 bg-[#111722]/90 shadow-[0_24px_80px_rgba(15,108,255,0.16)] transition-transform duration-200 ease-out"
          >
