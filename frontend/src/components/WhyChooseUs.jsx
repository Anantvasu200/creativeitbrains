...
export default function WhyChooseUs() {
  return (
    <section id="why-choose-us" className="relative overflow-hidden bg-[#090b10] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
          ...
          <div className="lg:col-span-7 grid gap-6 sm:grid-cols-2">
            {aboutHighlights.map(({ icon: Icon, title, text }, index) => (
              <motion.article
                ...
                className="relative rounded-xl border border-white/10 bg-[#11151b] p-6 text-left transition duration-200 hover:border-white/18 hover:bg-[#151b24]"
                key={title}
              >
                <div className="mb-6 grid size-12 place-items-center rounded-lg border border-white/10 bg-[#11151b] text-[#0f6cff]">
                  <Icon size={22} />
                </div>
