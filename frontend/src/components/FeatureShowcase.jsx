...
export default function FeatureShowcase() {
  ...
  return (
    <section id="showcase" className="relative overflow-hidden bg-[#070809] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl relative z-10">
        <div className="grid gap-8 border-t border-white/10 pt-10 lg:grid-cols-12 lg:items-end">
          ...
          >
            <span className="text-xs font-semibold uppercase tracking-[0.22em] text-[#8ee6df]">Selected Work</span>
        ...
        <div className="mt-10">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative overflow-hidden rounded-xl border border-white/10 bg-[#0d1012]"
            >
              <div className="grid lg:grid-cols-12">
                <div className="relative min-h-[360px] lg:col-span-7">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0d1012] via-[#0d1012]/28 to-transparent lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-[#0d1012]" />
                  <div className="absolute bottom-5 left-5 flex items-center gap-2 rounded-md bg-black/55 px-3 py-2 text-xs font-semibold text-white/82 backdrop-blur">
                    <span className="size-2 rounded-full bg-[#8ee6df]" />
                    Production project
                  </div>
                </div>

                <div className="relative z-10 p-6 sm:p-8 lg:col-span-5 lg:p-10">
                  <div className="text-xs font-semibold uppercase tracking-[0.2em] text-[#8ee6df]">
                  ...
                  <div className="mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10">
                    {showcaseItems[activeIndex].stats.map(([value, label]) => (
                      <div className="bg-[#111518] p-4" key={label}>
                  ...
                  <div className="mt-8 flex flex-wrap gap-2">
                    {showcaseItems[activeIndex].tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-md border border-white/10 bg-white/[0.03] px-3 py-1.5 text-xs font-semibold text-white/58"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <a
                    className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-white transition hover:text-[#8ee6df]"
                    href="#contact"
                  >
