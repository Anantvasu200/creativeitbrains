...
import { footerLinks, servicesProvided } from '../data/siteData.js';

export default function Footer() {
  return (
    <footer className="bg-[#090b10] border-t border-white/10 px-4 pt-16 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 pb-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1.2fr]">
          ...
          <div className="mt-6 flex gap-3">
            {[
              ...
              <a
                key={idx}
                href={social.href}
                className="grid size-9 place-items-center rounded-lg border border-white/10 bg-[#11151b] text-white/55 transition hover:border-white/18 hover:bg-white/[0.06] hover:text-[#0f6cff]"
              >
                {social.icon}
              </a>
            ))}
        ...
        <div className="text-left">
          ...
          <div className="mt-6">
            <form className="relative flex rounded-lg border border-white/10 bg-[#11151b] p-1 focus-within:border-white/18" onSubmit={(e) => e.preventDefault()}>
              <input
