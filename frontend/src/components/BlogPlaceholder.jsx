...
export default function BlogPlaceholder() {
  return (
    <section id="blog" className="relative overflow-hidden bg-[#070809] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="relative mx-auto max-w-3xl border-t border-white/10 pt-10 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#8ee6df]">Latest Blog</p>
        ...
        <div className="relative mt-12 grid gap-5 md:grid-cols-3">
          {['AI transformation notes', 'Web and app engineering', 'Digital marketing updates'].map((title) => (
            <article className="rounded-xl border border-white/10 bg-[#0d1012] p-7 transition duration-200 hover:border-white/18 hover:bg-[#111518]" key={title}>
              <Newspaper className="mb-8 text-[#8ee6df]" size={28} />
