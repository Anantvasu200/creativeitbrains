...
export default function BlogPlaceholder() {
  return (
    <section id="blog" className="relative overflow-hidden bg-[#f7fbff] px-4 py-20 text-slate-950 sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-7xl">
        <div className="relative mx-auto max-w-3xl border-t border-slate-200 pt-10 text-center">
          ...
          <p className="mt-5 text-base leading-8 text-slate-950/60 sm:text-lg">
        ...
        <div className="relative mt-12 grid gap-5 md:grid-cols-3">
          {['AI transformation notes', 'Web and app engineering', 'Digital marketing updates'].map((title) => (
            <article className="rounded-xl border border-slate-200 bg-white p-7 transition duration-200 hover:border-sky-200 hover:bg-[#eff6ff]" key={title}>
              <Newspaper className="mb-8 text-[#0f6cff]" size={28} />
              <h3 className="text-xl font-semibold">{title}</h3>
              <p className="mt-4 leading-7 text-slate-950/55">Blog content will be published here soon.</p>
              <div className="mt-8 flex flex-wrap gap-5 text-sm font-semibold text-slate-950/45">
